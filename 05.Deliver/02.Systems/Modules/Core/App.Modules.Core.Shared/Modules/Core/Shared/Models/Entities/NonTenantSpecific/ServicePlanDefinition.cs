...
namespace App.Modules.Core.Shared.Models.Entities
{
    ...
    ///     </para>
    /// </summary>
    public class ServicePlanDefinition : UntenantedRecordStatedTimestampedGuidIdReferenceDataEntityBase, IHasKey
    {
        ...
        public virtual ICollection<ServiceOfferingDefinition> ServiceAllocations =>
            _services ?? (_services = new Collection<ServiceOfferingDefinition>());
