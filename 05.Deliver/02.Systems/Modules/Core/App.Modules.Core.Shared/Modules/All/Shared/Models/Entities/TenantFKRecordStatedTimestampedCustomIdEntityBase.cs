...
namespace App.Modules.All.Shared.Models.Entities
{
        ...
        where TId: struct
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TenantFKRecordStatedTimestampedCustomIdEntityBase{TId}"/> class.
        /// </summary>
        protected TenantFKRecordStatedTimestampedCustomIdEntityBase() : base()
        {
