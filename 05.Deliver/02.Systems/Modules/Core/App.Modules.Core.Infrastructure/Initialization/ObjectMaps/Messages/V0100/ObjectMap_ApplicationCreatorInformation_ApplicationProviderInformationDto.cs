namespace App.Modules.Core.Infrastructure.Initialization.ObjectMaps.Messages.V0100
{
    ...
    public class ObjectMap_ApplicationCreatorInformation_ApplicationProviderInformationDto : IHasAutomapperInitializer
    {
        public void Initialize(IMapperConfigurationExpression config)
        {
            config.CreateMap<ApplicationCreatorInformationConfigurationSettings, ApplicationProviderInformationDto>()
