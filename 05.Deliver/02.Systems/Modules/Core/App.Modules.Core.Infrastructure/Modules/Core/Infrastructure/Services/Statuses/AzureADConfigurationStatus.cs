...
namespace App.Modules.Core.Infrastructure.Services.Statuses
{
    ...
    public class AzureADConfigurationStatus : ConfigurationStatusBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureADConfigurationStatus"/> class.
        /// </summary>
        public AzureADConfigurationStatus() 
