...
namespace App.Modules.Core.Infrastructure.Services.Statuses
{
    ...
    public class AzureBlobConfigurationStatus : ConfigurationStatusBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureBlobConfigurationStatus"/> class.
        /// </summary>
        public AzureBlobConfigurationStatus() 
