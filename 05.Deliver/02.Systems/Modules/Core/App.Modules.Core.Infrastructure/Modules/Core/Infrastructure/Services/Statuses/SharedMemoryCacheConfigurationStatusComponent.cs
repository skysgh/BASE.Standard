...
namespace App.Modules.Core.Infrastructure.Services.Statuses
{
    ...
    public class SharedMemoryCacheConfigurationStatusComponent : ConfigurationStatusComponentBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SharedMemoryCacheConfigurationStatusComponent"/> class.
        /// </summary>
        public SharedMemoryCacheConfigurationStatusComponent() : 
