...
namespace App.Modules.Core.Infrastructure.Services.Statuses
{
    ...
    public class AzureKeyVaultServiceConfigurationStatus : ConfigurationStatusBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureKeyVaultServiceConfigurationStatus"/> class.
        /// </summary>
        public AzureKeyVaultServiceConfigurationStatus() 
