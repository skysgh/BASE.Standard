...
namespace App.Modules.Core.Infrastructure.Services
{
    ...
    public interface IAzureDocumentDBService : IRemoteServiceClientInfrastructureService, IAzureService
    {
        ...
        /// <param name="throwExceptionIfAlreadyExisting">
        ///     if set to <c>true</c>, throws an exception if the database already
        ///     existing.
        /// </param>
        /// <returns></returns>
        ...
        /// <param name="throwExceptionIfAlreadyExists">
        ///     if set to <c>true</c>, throw an exception if the document collection
        ///     already exists.
        /// </param>
        ...
        /// <returns></returns>
        void CreateDocumentCollection(string databaseId, string collectionId, bool throwExceptionIfAlreadyExists = true,
            string[] keyColumnNames = null, int offerThroughput = 1000);
        ...
        /// <param name="offerThroughput">The offer throughput.</param>
        /// <returns></returns>
        Task CreateDocumentCollectionAsync(string databaseId, string collectionId,
        ...
        /// <returns></returns>
        Task<TDocument> GetDocumentAsync<TDocument>(string databaseId, string collectionId,
        ...
        /// <returns></returns>
        Task UpdateDocumentAsync<TDocument>(string databaseId, string collectionId, string documentId,
        ...
        /// <param name="throwExceptionIfNotFound">if set to <c>true</c> [throw exception if not found].</param>
        /// <returns></returns>
        Task UpdateDocumentAsync<TDocument>(string databaseId, string collectionId, TDocument updatedDocument,
            Uri documentUri = null, bool throwExceptionIfNotFound = true);


        void PersistDocument<TDocument>(string databaseId, string collectionId, TDocument document,
            bool saveBeforeUpdate = true);


        Task PersistDocumentAsync<TDocument>(string databaseId, string collectionId, TDocument document,
            bool saveBeforeUpdate = true);
        ...
        void DeleteDocument<TDocument>(string databaseId, string collectionId, TDocument document,
            bool throwExceptionIfNotFound = true);

        void DeleteDocument(string databaseId, string collectionId, string documentId,
            bool throwExceptionIfNotFound = true);
        ...
        Task DeleteDocumentAsync<TDocument>(string databaseId, string collectionId, TDocument document,
            bool throwExceptionIfNotFound = true);

        Task DeleteDocumentAsync(string databaseId, string collectionId, string documentId,
            bool throwExceptionIfNotFound = true);
        ...
        /// <param name="throwExceptionIfNotFound">if set to <c>true</c> [throw exception if not found].</param>
        /// <returns></returns>
        Task DeleteDocumentCollectionAsync(string documentId, string collectionId,
            bool throwExceptionIfNotFound = true);
