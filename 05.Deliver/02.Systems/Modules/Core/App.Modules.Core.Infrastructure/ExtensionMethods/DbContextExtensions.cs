...
namespace App
{
    ...
    public static class QueryableEFExtgensions
    {
        ...
        public static bool Any<TModel>(this DbContext context, Expression<Func<TModel, bool>> filter = null)
            where TModel : class
        {
            return filter != null ? context.Set<TModel>().Any(filter) : context.Set<TModel>().Any();
        }

        public static int Count<TModel>(this DbContext context, Expression<Func<TModel, bool>> filter = null)
            where TModel : class
        {
        ...
        public static IQueryable<TModel> GetQueryableSingle<TModel>(this DbContext context,
        ...
        public static IQueryable<TModel> GetByFilter<TModel>(this DbContext context,
            Expression<Func<TModel, bool>> filter,
        ...
        public static void AddOrUpdate<TModel>(this DbContext context,
        ...
        public static void PersistOnCommit<TModel, TId>(this DbContext context, TModel model)
            where TModel : class, IHasTimestamp
        {
            if (IsNew(model))
            {
        ...
        public static void DeleteOnCommit<TModel, TId>(this DbContext context, TId id)
            where TModel : class, IHasId<TId>, new()
        {
            var model = Activator.CreateInstance<TModel>();
            model.Id = id;
            EntityEntry<TModel> entityEntry = context.Entry(model);
        ...
        public static void DeleteOnCommit<TModel>(this DbContext context, Expression<Func<TModel, bool>> predicate)
            where TModel : class
        {
            IQueryable<TModel> models = context.GetByFilter(predicate, MergeOption.Undefined);
