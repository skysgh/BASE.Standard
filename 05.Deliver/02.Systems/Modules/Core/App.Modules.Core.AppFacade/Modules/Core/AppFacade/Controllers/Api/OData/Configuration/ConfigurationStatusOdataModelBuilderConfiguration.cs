...
namespace App.Modules.Core.AppFacade.Controllers.Api.OData.Configuration
{
    ...
    public class ConfigurationStatusOdataModelBuilderConfiguration
        : ModuleODataModelBuilderConfigurationBase<ConfigurationStatusDto>
    {
        /// <summary>
        ...
        /// <returns></returns>
        public override EntityTypeConfiguration<ConfigurationStatusDto> Define(ODataModelBuilder builder)
        {
