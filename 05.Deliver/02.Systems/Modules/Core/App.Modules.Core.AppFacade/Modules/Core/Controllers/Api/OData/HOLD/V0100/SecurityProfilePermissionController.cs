...
{
    public class SecurityProfilePermissionController : GuidIdActiveRecordStateCoreODataControllerBase<TenancySecurityProfilePermission, SecurityProfilePermissionDto>
    {
        public SecurityProfilePermissionController(
        ...
        public IQueryable<SecurityProfilePermissionDto> Get()
        {
            IQueryable<SecurityProfilePermissionDto> results;

            try
            {
                results =
                    InternalActiveRecords()
                        .ProjectTo<SecurityProfilePermissionDto>(
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        //[ODataRoute("({key})")]
        public SecurityProfilePermissionDto Get(Guid key)
        {
            var result =
                    InternalActiveRecords()
        ...
        //// POST api/values 
        public void Post(SecurityProfilePermissionDto value)
        {
            InternalPost(value);
        }
        ...
        [WebApiAppAuthorize(Roles = AppModuleApiScopes.WriteScope)]
        //// PUT api/values/5 
        public void Put(SecurityProfilePermissionDto value)
        {
            InternalPut(value);
        }
    }
